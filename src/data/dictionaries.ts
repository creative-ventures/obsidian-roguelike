import { Dictionary, ThemeName } from '../types';
...
// Map theme names to dictionaries
export const DICTIONARIES: Record<ThemeName, Dictionary> = {
...
// Get dictionary based on theme
export function getDictionary(theme?: string): Dictionary {
    if (theme && theme in DICTIONARIES) {
        return DICTIONARIES[theme as ThemeName];
    }
...
export function getAvailableThemes(): ThemeName[] {
    return Object.keys(DICTIONARIES) as ThemeName[];
}
